...
SELECT * FROM (VALUES(1, 2, 3)) AS V2(C1,C2,C3)


INSERT INTO data_bank.customer_nodes
  (customer_id, region_id, node_id, start_date, end_date)
SELECT V1.C1, V1.C2, V1.C3, V1.C4, V1.C5
FROM
(
VALUES
  ...
  ('500', '2', '2', '2020-04-15', '9999-12-31')) AS V1(C1, C2, C3, C4, C5);
...
SELECT V1.C1, V1.C2, V1.C3, V1.C4
FROM
(
VALUES
  ...
  ('189', '2020-01-27', 'withdrawal', '861')) AS V1(C1, C2, C3, C4);